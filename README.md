...
I have refactored most of old code to make use of the newer js feature browser can provide now.  Also provided with a test.

The lastest version is [here](https://github.com/jackysee/rssget/raw/master/rssget.user.js).
